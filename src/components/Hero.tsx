        ...
        duration: 0.8
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <h1 onClick={onLogoClick} className="font-display text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tight text-foreground mb-4 cursor-default select-none">
                SWASTIK
                <br />
